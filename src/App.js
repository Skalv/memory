...
class App extends React.Component {
    constructor(props) {
        super(props);
        this.handleSubmit = this.handleSubmit.bind(this); // bind nous permet d'accèder au context (App) dans la fonction handleSubmit
        this.state = {
    ...
    Une fois le peuso valider on passe à la page de jeu.
